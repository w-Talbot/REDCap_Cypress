...
describe('Export Data', () => {
    ...
    describe('Basic Functionality', () => {
        ...
        it('Should allow the ability to export specific forms', () => {
            ...
            // cy.get('input[value="csvraw"]').click()
            cy.get('#export_choices_table > tbody > :nth-child(1) > td').click() //select csv format

            cy.get('[style="font-weight: bold; color: rgb(51, 51, 51);"]').click() //export csv
            cy.get('.nowrap > a > img').click() // download csv

            cy.get('[aria-describedby="popup2104588291140732"] > .ui-dialog-titlebar').should(($csv) => {
                expect($csv).to.contain('Data Export was successful')
            })
